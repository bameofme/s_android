...
ifeq ($(BOARD_SOC_TYPE),IMX8Q)
include $(CLEAR_VARS)
LOCAL_MODULE := media_codecs_performance_c2_8qm.xml
LOCAL_SRC_FILES := imx8q/media_codecs_performance_c2_8qm.xml
LOCAL_MODULE_CLASS := ETC
LOCAL_VENDOR_MODULE := true
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE := media_codecs_performance_c2_8qxp.xml
LOCAL_SRC_FILES := imx8q/media_codecs_performance_c2_8qxp.xml
LOCAL_MODULE_CLASS := ETC
LOCAL_VENDOR_MODULE := true
include $(BUILD_PREBUILT)
endif
